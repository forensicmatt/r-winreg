...
pub fn get_reader_size<Rs: Read+Seek>(mut reader: Rs) -> Result<u64,RegError>{
...
pub fn read_string_u16_w_size<R: Read>(mut reader: R) -> Result<String,RegError> {
    // Reads into a string with the size preceeding the string
...
pub fn read_string_u8_till_null<R: Read>(mut reader: R) -> Result<String,RegError> {
...
pub fn read_string_u16_till_null<R: Read>(mut reader: R) -> Result<String,RegError> {
    // Reads into a string till a null char is reached
